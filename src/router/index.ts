...
import marshroutesRoutes from './modules/marshroutes'
...
export const asyncRoutes: RouteConfig[] = [
  ...
  tableRouter,
  {
    ...
    children: [
      {
        path: '/example',
        component: () => import(/* webpackChunkName: "tab" */ '@/views/nested/proxy/index.vue'),
  ...
  },
  {
    ...
    children: [{
      path: 'https://grafana.cargo.b-resh.ru/',
      meta: {
        title: 'stagingGrafana',
        icon: 'link'
      }
    },
    {
      path: 'https://portainer.cargo.b-resh.ru/',
      meta: {
        title: 'stagingPortainer',
        icon: 'link'
      }
    },
    {
